...
const Designs = () => {
  ...
  const renderImagesByCategory = (category) => {
    return imgUrl
      ...
      .map((item, index) => (
        <div
          key={index}
          className="item col-lg-4 col-sm-6 col-12 d-flex flex-column justify-content-center align-items-center mt-4"
        >
          <img
            src={item.url}
  ...
  return (
    ...
    <div>
      ...
      <section className="container design_sec1" style={{ marginTop: "100px" }}>
        <div className="row">
            ...
            <div className="tab-content" id="v-pills-tabContent">
              ...
              >
                ...
                <Pagination
                  ...
                  className="my-3"
                  total={
                    imgUrl.filter((item) => item.category === "SPACE_SAVING")
                      .length
                  }
              ...
              >
                <div className="row">{renderImagesByCategory("LIVING")}</div>
                <Pagination
                  current={currentPage}
                  onChange={handlePageChange}
                  defaultPageSize={pageSize}
                  className="my-3"
                  total={
                    imgUrl.filter((item) => item.category === "LIVING").length
                  }
                  style={{ margin: "auto", textAlign: "center" }}
                />
              </div>
              ...
              >
                <div className="row">{renderImagesByCategory("BEDROOM")}</div>
                <Pagination
                  current={currentPage}
                  onChange={handlePageChange}
                  defaultPageSize={pageSize}
                  className="my-3"
                  total={
                    imgUrl.filter((item) => item.category === "BEDROOM").length
                  }
                  style={{ margin: "auto", textAlign: "center" }}
                />
              </div>
              ...
              >
                <div className="row">{renderImagesByCategory("KITCHEN")}</div>
                <Pagination
                  current={currentPage}
                  onChange={handlePageChange}
                  defaultPageSize={pageSize}
                  className="my-3"
                  total={
                    imgUrl.filter((item) => item.category === "KITCHEN").length
                  }
                  style={{ margin: "auto", textAlign: "center" }}
                />
              </div>
